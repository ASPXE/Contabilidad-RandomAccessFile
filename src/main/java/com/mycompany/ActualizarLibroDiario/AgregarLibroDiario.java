 ...
 * @author aspxe
 */
public class AgregarLibroDiario extends javax.swing.JFrame {
    ...
    private void btnActualizarInformacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarInformacionActionPerformed
        ...
        ld.setFecha(fecha);
        ld.setCargoOAbono(cargoOAbono);
        
        arch.agregarLibroDiario("LibroDiario-"+dia+"-"+mes+"-"+year+".dat", ld);
        
        try {
            //Leemos el libro mayor de un año existente, lo leemos y modificamos montoMes
            arch.actualizarLibroMayor("LibroMayor-"+year+".dat", ld, ald);
            arch.reporteLibroMayor("LibroMayor-"+year+".dat");
        } catch (IOException ex) {
            Logger.getLogger(AgregarLibroDiario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarLibroDiario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarLibroDiario().setVisible(true);
            }
        });
    }
